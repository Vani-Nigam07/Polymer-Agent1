...
from OpenMacromolecularGenome.generation.selfies.constants import AROMATIC_SUBSET, ELEMENTS, ORGANIC_SUBSET, ASTERISK
from OpenMacromolecularGenome.generation.selfies.exceptions import SMILESParserError
from OpenMacromolecularGenome.generation.selfies.mol_graph import Atom, Attribution, \
    ...
    while i < len(smiles):
        ...
        if i == len(smiles):
            ...
            if smiles[i: i + 2] in ("Br", "Cl"):  # two-letter elements
                ...
                token = SMILESToken(bond_idx, i, i + 1, SMILESTokenTypes.ATOM, smiles[i:i + 1])
